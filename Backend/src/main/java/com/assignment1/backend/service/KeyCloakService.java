...
public class KeyCloakService {
    ...
    public String getAdminToken() {
        ...
        try {
            ...
            log.error("Failed to get admin token: HTTP {} {}, Details: {}", e.getStatusCode(), e.getStatusText(), e.getResponseBodyAsString());
    ...
    public void createKeycloakUser(RegisterRequest request) {
        log.debug("Creating Keycloak user: {}", request.getUsername());
        ...
        userData.put("credentials", new Map[]{credential});

        HttpEntity<Map<String, Object>> httpEntity = new HttpEntity<>(userData, headers);
    ...
    public Map<String, Object> authenticateUser(LoginRequest request) {
        ...
        log.debug("Authenticating user {} at {}", request.getUsername(), url); 
    ...
    public void logoutUser(String refreshToken) {
        String url = keycloakAuthServerUrl + "/realms/" + keycloakRealm + "/protocol/openid-connect/logout";
